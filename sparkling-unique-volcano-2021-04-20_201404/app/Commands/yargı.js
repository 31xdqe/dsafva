...
module.exports.execute = async (client, message, args) => {
    ...
    message.channel.send(embed.setImage(`https://cdn.discordapp.com/attachments/806927976558100512/830474799188017172/HoarseRashDodobird-size_restricted.gif`).setDescription(`${victim} (\`${victim.id}\`) ${message.author} tarafından yargılandı.`));
